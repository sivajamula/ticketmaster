	                    ...
	                    <!-- general form elements -->
                          <div class="panel panel-primary">
                            <div class="panel-heading">
                                <a href="tela_cad_evento.jsp?id=0"><button class="btn btn-default">Novo Evento</button></a>
                            </div><!-- /.box-header -->
		                                        ...
		                                        <%
	                                                ...
	                                                for(Evento det: list){
	                                                	out.print("<tr>");
		                                                    ...
		                                                    out.print("<td>"+  det.getOperador().getNome() +"</td>");
		                                                    out.print("<td><a href='tela_cad_evento.jsp?acao=alterar&id="+  det.getId_evento()+"'><button class='btn btn-warning'>Alterar</button></a></td>");
		                                                    out.print("<td><a href='tela_cad_evento.jsp?acao=excluir&id="+  det.getId_evento()+"'><button class='btn btn-danger'>Excluir</button></a></td>");
		                                                    out.print("</form>");
	                                                    out.print("</tr>");
