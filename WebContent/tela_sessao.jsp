	                    ...
	                    <!-- general form elements -->
                          <div class="panel panel-primary">
                            <div class="panel-heading">
                                <a href="tela_cad_sessao.jsp?id=0"><button class="btn btn-default">Nova Sessão</button></a>
                            </div><!-- /.box-header -->
 								...
 								<table class="table table-hover">
		                                ...
		                                <tbody>
		                                        <%
	                                                ...
	                                                for(Sessao det: list){
	                                                	out.print("<tr>");
		                                                    out.print("<td>"+  det.getData()+"</td>");
		                                                    out.print("<td>"+  det.getEvento().getNome() +"</td>");
		                                                    out.print("<td><a href='tela_cad_sessao.jsp?acao=alterar&id="+  det.getId_sessao()+"'><button class='btn btn-warning'>Alterar</button></a></td>");
		                                                    out.print("<td><a href='tela_cad_sessao.jsp?acao=excluir&id="+  det.getId_sessao()+"'><button class='btn btn-danger'>Excluir</button></a></td>");
		                                                    out.print("</form>");
	                                                    out.print("</tr>");
